...
namespace EHRIS.Core.Entities
{
    ...
    public class AcpLeave
    {
        ...
        /// </summary>
        [Column("funeral_type")]
        public byte FuneralType { get; set; }

        /// <summary>
        /// foreign_type
        /// </summary>
        [Column("foreign_type")]
        public byte ForeignType { get; set; }
        ...
        public byte OfficialType { get; set; }

        /// <summary>
        /// maternity_type
        /// </summary>
        [Column("maternity_type")]
        public byte MaternityType { get; set; }

        /// <summary>
        /// covid19_type
        /// </summary>
        [Column("covid19_type")]
        public byte Covid19Type { get; set; }
