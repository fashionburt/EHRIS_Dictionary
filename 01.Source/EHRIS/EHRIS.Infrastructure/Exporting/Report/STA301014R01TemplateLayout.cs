...
{
    public class STA301014R01TemplateLayout : ReportTemplateLayoutBase
    {
        public override bool ShouldPrintFooterSummary { get; set; } = true;
        public string _sMonthText = string.Empty;
        
        public STA301014R01TemplateLayout(string sMonthText)
        {
        ...
        public override int ApplyLayout(ExcelGenerater excelGen, string TitleName)
        {
            ...
            //第二層標題
            RowIdx++;
            excelGen.Cell("單位別", RowIdx, ColIdx, RowIdx + 1, ColIdx, 12, HorizontalAlignment.Center); ColIdx++;
            ...
            //單位別
            excelGen.SetColumnWidth(0, 28.5);
        ...
        public override void RenderFooterSummary<T>(ExcelGenerater excelGen, List<T> data, int summaryRow)
        {
            ...
            for (int colIdx = 1; colIdx < props.Length; colIdx += 2)
            {
                ...
                excelGen.ApplyCellFormatStyle(rowStartIdx, colIdx, rowStartIdx, colIdx + 1, CellFormatStyle.Integer);
            }
            excelGen.SetHorizontalAlignment(3, 0, summaryRow, 0, HorizontalAlignment.Justify, VerticalAlignment.Center);
