...
{
    public class STA301013R01TemplateLayout : ReportTemplateLayoutBase
    {
        ...
        public STA301013R01TemplateLayout( string sMonthText, string eMonthText)
        { 
        ...
        public override int ApplyLayout(ExcelGenerater excelGen, string TitleName)
        {
            ...
            //第二層標題
            RowIdx++;
            excelGen.Cell("日數", RowIdx, ColIdx, RowIdx + 1, ColIdx, 12, HorizontalAlignment.Center); ColIdx++;
            ...
            //單位別
            excelGen.SetColumnWidth(0, 25.14);
            excelGen.SetBorderRange(2, 0, 3, ColumnNum - 1);
            return 4;
        }
